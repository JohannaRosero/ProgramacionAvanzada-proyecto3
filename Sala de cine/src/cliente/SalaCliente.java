 ...
 * @author Usuario
 */
public class SalaCliente extends javax.swing.JFrame {

    /**
     * Creates new form SalaCliente
     */
    int matriz[][] = new int[5][5];
    JButton[][] bMatriz = new JButton[5][5];
    int count0 = 0;
    Registry registry;
    public SalaCliente(int matriz2[][]) throws RemoteException, NotBoundException, AlreadyBoundException {
        ...
        Remote stub = UnicastRemoteObject.exportObject(new TestRemote() {
            ...
            public void sayHello(int fila , int columna) throws RemoteException {
                ...
                cargarAcientos();
                System.out.println("paso de rmi server");
            }
        }, 0);
    ...
    private void btn04ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn04ActionPerformed
        try {
            ...
            Logger.getLogger(SalaCliente.class.getName()).log(Level.SEVERE, null, ex);
...
//
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalaCliente.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                    ...
                    new SalaCliente().setVisible(true);
            }
        });
